...
function APIElement2({ layout = "sidebar", currentVersion = "v1-2" }) {
  return (
    <BrowserOnly
      fallback={
        <div className="loading-container">
          <h1>API Reference 2 is loading...</h1>
        </div>
      }
    >
      {() => {
...
export default function Home() {
  ...
  const currentVersion = url.searchParams.get("v") || "v1-2";
  ...
  return (
    ...
    >
      <Head>
        ...
        <link rel="preload" href="/css/elements.min.css" as="style" />
