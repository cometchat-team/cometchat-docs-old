  ...
  return (
    <section className="bg-secondary-1000 px-4 py-20" id="start-building">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="my-website-badge">{sdksData.title}</div>

        <div className="sticky top-14 z-20 -mt-2 flex flex-col items-center gap-6 bg-secondary-1000 py-6 lg:flex-row lg:justify-between lg:py-0">
